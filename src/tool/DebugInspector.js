...
export default function makeInspector(myDiagram) {
    window.$ = go.GraphObject.make;
    window.inspector = new DebugInspector('myInspector', myDiagram,
        {
            acceptButton: true,
            resetButton: true,
...
View.prototype.populate = function (val) {
    ...
    switch (type) {
        ...
        //     var selected = go.GraphObject.make(brushTextField);
